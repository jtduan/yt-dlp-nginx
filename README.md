...
## General Options:
    ...
    --update-to [CHANNEL]@[TAG]     Upgrade/downgrade to a specific version.
                                    ...
                                    and TAG default to "jtduan/yt-dlp-nginx" and
...
## Network Options:
    --custom-host-youtube DOMAIN    customize domain prefix: youtube.com
    --custom-host-googlevideo DOMAIN customize domain prefix: googlevideo.com
